  ...
  'foundations/tokens/our-tokens': {
    ...
    render: (tab) => {
      ...
      const sizes = [
        ...
        ['base-sizing-7xl',  '2.25rem',  '36px'],
        ['base-sizing-8xl',  '2.5rem',   '40px'],
        ['base-sizing-9xl',  '2.75rem',  '44px'],
        ['base-sizing-10xl', '3rem',     '48px'],
        ['base-sizing-11xl', '3.25rem',  '52px'],
        ['base-sizing-12xl', '3.5rem',   '56px'],
        ['base-sizing-13xl', '3.75rem',  '60px'],
        ['base-sizing-14xl', '4rem',     '64px'],
        ['base-sizing-15xl', '4.25rem',  '68px'],
        ['base-sizing-16xl', '4.5rem',   '72px'],
        ['base-sizing-17xl', '4.75rem',  '76px'],
        ['base-sizing-18xl', '5rem',     '80px'],
        ['base-sizing-19xl', '5.25rem',  '84px'],
        ['base-sizing-20xl', '5.5rem',   '88px'],
        ['base-sizing-21xl', '5.75rem',  '92px'],
